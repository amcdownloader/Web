...
class The7_Exend_Image_Widget {
	...
	public function inject_sticky_settings( $widget ) {
		...
		$selector = 'body .the7-e-sticky-effects:not(.the7-e-sticky-spacer) .the7-img-sticky-size-effect-yes.elementor-element-{{ID}} img,
		body .the7-e-sticky-effects:not(.the7-e-sticky-spacer) .the7-img-sticky-size-effect-yes.elementor-element-{{ID}} svg';
		...
		$selector = 'body .the7-e-sticky-effects:not(.the7-e-sticky-spacer) .elementor-element.elementor-element-{{ID}} img,
		body .the7-e-sticky-effects:not(.the7-e-sticky-spacer) .elementor-element.elementor-element-{{ID}} svg';
	...
	private function get_inline_image_by_url( $url = null, $attr = array() ) {
		...
		if ( ! $image_content ) {
			...
			$image_content = $filesystem->get_contents( $image_path );
			if ( 'svg' !== $ext ) {
				$image_content = the7_base_64_encode( $image_content );
			}
		}
